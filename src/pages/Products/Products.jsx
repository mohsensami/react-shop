          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="flex flex-col gap-4">
              <img
                ...
                src={Array.isArray(data?.data?.images) ? data.data.images[activeImageIndex] : data?.data?.images}
                alt={data?.data?.title}
              />
              <div className="flex gap-2 flex-wrap">
                {Array.isArray(data?.data?.images) && data.data.images.map((image, index) => (
                  <img
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex items-center gap-2">
                <span className="text-2xl font-semibold text-blue-600">${data?.data?.price}</span>
              </div>
              ...
              <div className="border-t border-b border-gray-200 py-6 my-4">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center border rounded-lg">
                    ...
                    <span className="px-4 py-2 text-lg font-medium border-x">{quantity}</span>
                    <button 
